...
import ihl.processing.metallurgy.*;
...
public class IHLRecipes {

	private static ItemStack pfaalimestone;
	private static ItemStack pfaacobblelimestone;
	...
	public static void RegisterRecipes(){
		...
		if (IHLMod.isGregTechModLoaded) {
			if (IHLMod.isGT_API_Version_5) {
				loadGT5Recipes();
			} else {
				loadGT6Recipes();
			}
		...
		RegisterIronWorkbenchRecipes();
		RegisterAchesonFurnaceRecipes();
		RegisterLeadOvenRecipes();
		RegisterImpregnationRecipes();
		RegisterDetonationSprayingMachineRecipes();
		RegisterMuffleFurnaceRecipes();
		RegisterLoomRecipes();
		RegisterRollingRecipes();
		RegisterChemicalReactorRecipes();
		RegisterEvaporationRecipes();
		RegisterLabElectrolyzerRecipes();
		RegisterFluidizedBedReactor();
		RegisterFurnaceRecipes();
		RegisterFractionatorRecipes();
		...
		// equals to 1.5 sq. mm.
		IHLMod.fluidDictionary.registerFluidStack("water", IHLUtils.getFluidStackWithSize("water", 1000));
		IHLMod.fluidDictionary.registerFluidStack("water", IHLUtils.getFluidStackWithSize("ic2distilledwater", 1000));
		IHLMod.fluidDictionary.registerFluidStack("lubricant", IHLUtils.getFluidStackWithSize("seedoil", 1000));
		IHLMod.fluidDictionary.registerFluidStack("lubricant", IHLUtils.getFluidStackWithSize("oleicacid", 1000));
		IHLMod.fluidDictionary.registerFluidStack("lubricant", IHLUtils.getFluidStackWithSize("mineraloil", 1000));
		if (FluidRegistry.isFluidRegistered("lubricant"))
			IHLMod.fluidDictionary.registerFluidStack("lubricant", IHLUtils.getFluidStackWithSize("lubricant", 1000));
		...
		for (ElectricConductor ec : ElectricConductor.values()) {
			...
			if (FluidRegistry.isFluidRegistered(fluidName)) {
				...
				IHLMod.log.debug("added recipe for " + fluidName);
	...
	private static void RegisterIronWorkbenchRecipes(){
		...
		IronWorkbenchTileEntity.addRecipe(new IronWorkbenchRecipe(null,
			...
			Arrays.asList(new ItemStack[] { IHLUtils.getItemStackWithTag("ihlExplosive", "explosionPower",
				15 * IHLMod.config.explosionPowerBase) }),
			null));
		IronWorkbenchTileEntity.addRecipe(new IronWorkbenchRecipe(null,
			Arrays.asList(new IRecipeInput[] { new RecipeInputOreDict("platePaper", 2),
				...
				new RecipeInputOreDict("ingotTarPitch", 1), new RecipeInputDetonator(detonator) }),
			Arrays.asList(new ItemStack[] { IHLUtils.getItemStackWithTag("ihlExplosive", "explosionPower",
				10 * IHLMod.config.explosionPowerBase) }),
			null));
		IronWorkbenchTileEntity.addRecipe(new IronWorkbenchRecipe(null,
			Arrays.asList(new IRecipeInput[] { new RecipeInputOreDict("platePaper", 2),
			...
			Arrays.asList(new ItemStack[] { IHLUtils.getItemStackWithTag("ihlExplosive", "explosionPower",
				3 * IHLMod.config.explosionPowerBase) }),
			null));
	}

	private static void RegisterAchesonFurnaceRecipes(){
	...
	private static void RegisterLeadOvenRecipes(){
	...
	private static void RegisterImpregnationRecipes(){
	...
	private static void RegisterMuffleFurnaceRecipes(){
		...
		MuffleFurnanceTileEntity.addRecipe(
			new RecipeInputItemStack(new ItemStack(BlocksAndItems.crucible, 1, OreDictionary.WILDCARD_VALUE), 1),
			new ItemStack(BlocksAndItems.crucible, 1, 1));
		MuffleFurnanceTileEntity.addRecipe(
	...
	private static void RegisterRollingRecipes(){
	...
	private static void RegisterChemicalReactorRecipes(){
	...
	private static void RegisterEvaporationRecipes(){
	...
	private static void RegisterLabElectrolyzerRecipes(){
	...
	private static void RegisterFluidizedBedReactor(){
	...
	private static void RegisterFractionatorRecipes(){
	...
	private static void loadIC2Recipes() {
		ItemStack crystal = IC2Items.getItem("lapotronCrystal").copy();
		ItemStack advBattery = IC2Items.getItem("advBattery").copy();
		ItemStack chargedReBattery = IC2Items.getItem("chargedReBattery").copy();
		crystal.setItemDamage(OreDictionary.WILDCARD_VALUE);
	...
	private static void loadGT5Recipes() {
		ItemStack pfaalimestone = IHLUtils.getOtherModItemStackWithDamage("PFAAGeologica", "mediumStone", 0, 1);
		ItemStack pfaacobblelimestone = IHLUtils.getOtherModItemStackWithDamage("PFAAGeologica", "mediumCobble", 0, 1);
	...
	@SuppressWarnings("deprecation")
	private static void loadGT6Recipes() {
		ItemStack pfaalimestone = IHLUtils.getOtherModItemStackWithDamage("PFAAGeologica", "mediumStone", 0, 1);
		ItemStack pfaacobblelimestone = IHLUtils.getOtherModItemStackWithDamage("PFAAGeologica", "mediumCobble", 0, 1);
