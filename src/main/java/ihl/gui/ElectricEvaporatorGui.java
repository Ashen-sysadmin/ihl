...
import ihl.container.ElectricEvaporatorContainer;
...
public class ElectricEvaporatorGui extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        fontRendererObj.drawString(title, 8, 70, 6171880);
            ...
            if (this.container.getTileEntity().getFluidTank().getFluid()!=null && this.container.getTileEntity().getFluidTank().getFluidAmount() > 0)
            {
            	FluidStack fluidStack = this.container.getTileEntity().getFluidTank().getFluid();
            	if(fluidStack!=null)
            	{
            		...
            		if(fluid!=null)
            		{
            			...
            			if (fluidIcon != null)
            			{
            				...
            				int liquidHeight = this.container.getTileEntity().gaugeLiquidScaled(47);
