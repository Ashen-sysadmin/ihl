...
import ihl.container.ImpregnatingMachineContainer;
...
public class ImpregnatingMachineGui extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        int yOffset = (this.height - ySize) / 2;
            ...
            {
            	IHLRenderUtils.instance.renderIHLFluidTank(this.container.getTileEntity().getFluidTank(), 50, 11, 107, 72, zLevel, par1, par2, xOffset, yOffset);
            }
    }
