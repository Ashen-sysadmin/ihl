...
import ihl.container.LoomContainer;
...
public class LoomGui extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        int yOffset = (this.height - ySize) / 2;
            ...
            if (this.container.getTileEntity().progress > 0)
            {
            	...
            	i1 = Math.min(this.container.getTileEntity().gaugeProgressScaled(38),38);
    ...
    {
    	super.onGuiClosed();
    	this.container.getTileEntity().isGuiScreenOpened=false;
		IC2.network.get().initiateClientTileEntityEvent(this.container.getTileEntity(), 0);
    }
