...
import ihl.container.FluidizedBedReactorContainer;
...
public class FluidizedBedReactorGui extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		if (this.container.getTileEntity().progress > 0) {
			i1 = Math.min(this.container.getTileEntity().gaugeProgressScaled(17), 17);
		...
		if (this.container.getTileEntity().getTankAmount() > 0) {
			IHLRenderUtils.instance.renderIHLFluidTank(this.container.getTileEntity().getFluidTank(), 126, 28, 138, 59,
