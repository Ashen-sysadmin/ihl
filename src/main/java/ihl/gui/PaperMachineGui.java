...
import ihl.container.PaperMachineContainer;
...
public class PaperMachineGui extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        int yOffset = (this.height - ySize) / 2;
            ...
            {
            	IHLRenderUtils.instance.renderIHLFluidTank(this.container.getTileEntity().getFluidTank(), 102, 28, 114, 59, zLevel, par1, par2, xOffset, yOffset);
            }
    }
