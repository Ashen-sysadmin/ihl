...
import ihl.container.ElectrolysisBathContainer;
...
public class ElectrolysisBathGui extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        int yOffset = (this.height - ySize) / 2;
            ...
            {
            	IHLRenderUtils.instance.renderIHLFluidTank(this.container.getTileEntity().getFluidTank(), 32, 11, 89, 72, zLevel, par1, par2, xOffset, yOffset);
            }
            this.mc.renderEngine.bindTexture(background);
