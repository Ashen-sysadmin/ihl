...
public class CryogenicDistillerContainer extends BasicElectricMotorContainer<CryogenicDistillerTileEntity> {
	...
	public CryogenicDistillerContainer(EntityPlayer entityPlayer,
        ...
        this.addSlotToContainer(new SlotInvSlot(tileEntity.fillInputSlotInput,0, 58, 51));
        this.addSlotToContainer(new SlotInvSlot(tileEntity.fillInputSlotProducts,0, 103, 51));
        this.addSlotToContainer(new SlotInvSlot(tileEntity.fluidItemsSlot,0, 58, 15));
        this.addSlotToContainer(new SlotInvSlot(tileEntity.fluidItemsSlot,1, 103, 15));
	}
