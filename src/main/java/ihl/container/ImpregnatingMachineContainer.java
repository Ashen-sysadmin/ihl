...
public class ImpregnatingMachineContainer extends AbstractIHLContainer<ImpregnatingMachineTileEntity> {
	...
	@Override
	public ImpregnatingMachineTileEntity getTileEntity() {
