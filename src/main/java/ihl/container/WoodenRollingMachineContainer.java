...
public class WoodenRollingMachineContainer extends AbstractIHLContainer<WoodenRollingMachinePart1TileEntity> {
	...
	@Override
	public WoodenRollingMachinePart1TileEntity getTileEntity() {
