...
@Deprecated
public class MachineBaseContainer<T extends MachineBaseTileEntity> extends AbstractIHLContainer<T> {

    public int lastProgress = -1;
	private short lastEnergy;
    private final static int height=166;

    public MachineBaseContainer(EntityPlayer entityPlayer, T tileEntity1){
        super(tileEntity1);
        int col;
	...
	public int getGUIEnergy(int num){
		return this.tileEntity.getGUIEnergy(num);
	};
}
