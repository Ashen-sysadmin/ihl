...
public class GaedesMercuryRotaryPumpContainer extends AbstractIHLContainer<GaedesMercuryRotaryPumpTileEntity> {
	...
	@Override
	public GaedesMercuryRotaryPumpTileEntity getTileEntity() {
